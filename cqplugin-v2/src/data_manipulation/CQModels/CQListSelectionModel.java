...
//CURRENTLY NO USED!!!! FOUND A WAY TO AVOID USING THIS (plus, I hadn't really found a way to use this and solve my problems)

//FINALLY NOT USED. IT STAYS HERE FOR LEGACY AND DOCUMENTATION REASONS
...
import data_manipulation.CQPAbstractListSelectionModel;
//http://grepcode.com/file/repository.grepcode.com/java/root/jdk/openjdk/7u40-b43/javax/swing/DefaultListSelectionModel.java#DefaultListSelectionModel
public class CQListSelectionModel extends CQPAbstractListSelectionModel {


	private static final long serialVersionUID = -2644983237634055626L;
	private static final int MIN = -1;
	private static final int MAX = Integer.MAX_VALUE;
	private static int selectionMode = MULTIPLE_INTERVAL_SELECTION;
	private static int minIndex = MAX;
	private static int maxIndex = MIN;
	private static int anchorIndex = -1;
	private static int leadIndex = -1;
	private static int firstAdjustedIndex = MAX;
	private static int lastAdjustedIndex = MIN;
	private static boolean isAdjusting = false;

	private static int firstChangedIndex = MAX;
	private static int lastChangedIndex = MIN;


	private static BitSet value = new BitSet(32);
	protected static EventListenerList listenerList = new EventListenerList();


	protected static boolean leadAnchorNotificationEnabled = true;
	...
	protected void fireValueChanged(int firstIndex, int lastIndex, boolean isAdjustin){
	...
	public void setLeadAchorNotificationEnabled(boolean flag){
	...
	public Object clone() throws CloneNotSupportedException {
		CQListSelectionModel clone = (CQListSelectionModel)super.clone();
